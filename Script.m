...
exp1_sys = imread(fullfile(folderexpert,'IM-0001-0020-icontour-manual.pgm'))/255;
exp1_dias = imread(fullfile(folderexpert,'IM-0001-0028-icontour-manual.pgm'))/255;

exp2_sys = imread(fullfile(folderexpert,'IM-0001-0040-icontour-manual.pgm'))/255;
exp2_dias = imread(fullfile(folderexpert,'IM-0001-0048-icontour-manual.pgm'))/255;

exp3_sys = imread(fullfile(folderexpert,'IM-0001-0060-icontour-manual.pgm'))/255;
exp3_dias = imread(fullfile(folderexpert,'IM-0001-0068-icontour-manual.pgm'))/255;

exp4_sys = imread(fullfile(folderexpert,'IM-0001-0080-icontour-manual.pgm'))/255;
exp4_dias = imread(fullfile(folderexpert,'IM-0001-0088-icontour-manual.pgm'))/255;

exp5_sys = imread(fullfile(folderexpert,'IM-0001-0100-icontour-manual.pgm'))/255;
exp5_dias = imread(fullfile(folderexpert,'IM-0001-0108-icontour-manual.pgm'))/255;
...
img2_sys_bin  = imbinarize(img2_sys_S, 0.23);
img3_sys_bin  = imbinarize(img3_sys_S, 0.3);
